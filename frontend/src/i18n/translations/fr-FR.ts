export default {
  ...
  // END navbar
  // /
  "home.title": "Partage de fichiers sécurisé pour les équipes, partenaires ou clients.",
  "home.description": "Téléversez des fichiers, créez un lien sécurisé et envoyez-le par e-mail.",
  ...
  "home.trust.residency.title": "Stockage des données",
  "home.trust.residency.swiss": "Les données sont stockées exclusivement en Suisse.",
  "home.trust.residency.generic": "Les données restent protégées dans la région et l’infrastructure configurées par l’exploitant.",
  ...
  "home.trust.hardened.description": "La plateforme est renforcée sur le plan de la sécurité et conçue pour une exploitation fiable.",
  "home.trust.opensource.title": "Open source",
  "home.trust.opensource.description": "Le code source est public sur GitHub et peut être consulté à tout moment.",
  ...
  "common.button.share": "Créer un lien sécurisé",
