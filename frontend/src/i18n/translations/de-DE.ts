export default {
  ...
  // END navbar
  // /
  "home.title": "Sichere Dateifreigabe für Teams, Partner oder Klienten.",
  "home.description": "Dateien hochladen, einen sicheren Link erstellen und diesen per E-Mail versenden.",
  ...
  "home.trust.hardened.title": "Gehärtet",
  "home.trust.hardened.description": "Die Plattform ist sicherheitstechnisch gehärtet und wurde für einen zuverlässigen Betrieb ausgelegt.",
  ...
  "account.reverseShares.title": "Daten via sicheren Link einfordern",
  "account.reverseShares.description": "Erstelle einen Daten Anfrage-Link, wenn externe Personen dir Dateien sicher senden können.",
  "account.reverseShares.title.empty": "Nichts vorhanden",
  "account.reverseShares.description.empty": "Du hast keine Daten-Anfragen erstellt.",
  // showCreateReverseShareModal.tsx
  "account.reverseShares.modal.title": "Daten Anfrage-Link erstellen",
