export default {
  ...
  "home.trust.title": "Perché le organizzazioni si fidano di questo servizio",
  "home.trust.residency.title": "Archiviazione dei dati",
  "home.trust.residency.swiss": "I dati sono archiviati esclusivamente in Svizzera.",
  "home.trust.residency.generic": "I dati restano protetti nella regione e nell'infrastruttura configurate dall'operatore.",
  "home.trust.encryption.title": "Crittografia dei dati",
  "home.trust.encryption.description": "I dati sono protetti con una crittografia sicura durante il trasferimento e l'archiviazione.",
  "home.trust.no-analysis.title": "Nessuna analisi dei dati",
  "home.trust.no-analysis.description": "I dati restano sempre privati e non vengono usati per machine learning o altri scopi.",
  "home.trust.hardened.title": "Rafforzata",
  "home.trust.hardened.description": "La piattaforma è rafforzata dal punto di vista della sicurezza ed è progettata per un funzionamento affidabile.",
  "home.trust.opensource.title": "Open source",
  "home.trust.opensource.description": "Il codice sorgente è pubblicamente disponibile su GitHub e può essere consultato in qualsiasi momento.",
  ...
  "admin.config.general.powered-by-text": "Testo del brand nel footer",
  "admin.config.general.powered-by-text.description": "Testo del brand collegato nel footer dopo \"Powered by\".",
  "admin.config.general.powered-by-url": "URL del brand nel footer",
  "admin.config.general.powered-by-url.description": "Link usato per il testo del brand nel footer dopo \"Powered by\".",
  ...
  "admin.config.general.location": "Posizione",
  ...
  "common.button.share": "Crea link sicuro",
