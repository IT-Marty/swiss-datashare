export default {
  ...
  "home.trust.title": "Por qué las organizaciones confían en este servicio",
  "home.trust.residency.title": "Ubicación de los datos",
  "home.trust.residency.swiss": "Los datos se almacenan exclusivamente en Suiza.",
  "home.trust.residency.generic": "Los datos permanecen protegidos en la región y la infraestructura configuradas por el operador.",
  "home.trust.encryption.title": "Cifrado de datos",
  "home.trust.encryption.description": "Los datos se protegen con cifrado seguro durante la transferencia y el almacenamiento.",
  "home.trust.no-analysis.title": "Sin análisis de datos",
  "home.trust.no-analysis.description": "Los datos permanecen privados en todo momento y no se utilizan para aprendizaje automático ni para otros fines.",
  "home.trust.hardened.title": "Reforzado",
  "home.trust.hardened.description": "La plataforma está reforzada en seguridad y diseñada para un funcionamiento fiable.",
  "home.trust.opensource.title": "Código abierto",
  "home.trust.opensource.description": "El código fuente está disponible públicamente en GitHub para poder revisarlo en cualquier momento.",
  "home.how.title": "Así funciona",
  ...
  "admin.config.general.powered-by-text": "Texto de marca del pie de página",
  "admin.config.general.powered-by-text.description": "Texto de la marca enlazada en el pie de página después de «Powered by».",
  "admin.config.general.powered-by-url": "URL de marca del pie de página",
  "admin.config.general.powered-by-url.description": "Enlace usado para el texto de marca del pie de página después de «Powered by».",
  ...
  "admin.config.general.location": "Ubicación",
  "admin.config.general.location.description": "Controla el contenido de la interfaz según la ubicación (p. ej. \"swiss\"). Déjalo vacío para el comportamiento predeterminado.",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente Swiss DataShare guarda la información en caché en memoria. Si ejecutas varias instancias de Swiss DataShare, debes activar la caché Redis para compartirla entre instancias.",
  "admin.config.cache.redis-url": "URL de Redis",
  "admin.config.cache.redis-url.description": "URL para conectarse a la instancia de Redis usada para la caché.",
  ...
  "admin.config.s3.use-checksum": "Usar suma de verificación",
  "admin.config.s3.use-checksum.description": "Desactívalo para backends que no soporten sumas de verificación (p. ej., B2).",
  ...
  "common.button.share": "Crear enlace seguro",
