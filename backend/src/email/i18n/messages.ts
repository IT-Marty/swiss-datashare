...
const emailMessages: Record<SupportedEmailLocale, EmailCopy> = {
  "en-US": {
    ...
    shareRecipients: {
      subject: "{appName}: New files were shared with you.",
      preheader: "Open the secure link to view and download the shared files.",
      title: "You have received new files.",
      intro: "The sharing was done by {creator} ({creatorEmail}).",
      actionLabel: "View shared files",
      availabilityLine: "This link expires on {expires}.",
      messageLine: "Note from sender: {description}",
    },
    reverseShare: {
      subject: "{appName}: New data was shared via your data request.",
      preheader: "Open the secure link to view and download the shared data.",
      title: "New data is waiting for you.",
      intro: "The sharing was done by {creator} ({creatorEmail}).",
      actionLabel: "View shared data",
      messageLine: "Note from sender: {note}",
    },
    resetPassword: {
  ...
  "de-DE": {
    ...
    shareRecipients: {
      subject: "{appName}: Neue Daten wurden mit Ihnen geteilt.",
      preheader: "Öffnen Sie den sicheren Link, um die übertragenen Daten anzuzeigen und herunterzuladen.",
      title: "Es wurden neue Daten für Sie freigegeben.",
      intro: "Die Freigabe erfolgte durch {creator} ({creatorEmail}).",
      actionLabel: "Übertragene Daten einsehen",
      availabilityLine: "Dieser Link läuft ab am {expires}.",
      messageLine: "Hinweis des Absenders: {description}",
    },
    reverseShare: {
      subject: "{appName}: Neue Daten wurden über Ihre Dateianfrage freigegeben.",
      preheader: "Öffnen Sie den sicheren Link, um die übertragenen Daten anzuzeigen und herunterzuladen.",
      title: "Neue Daten warten auf Sie.",
      intro: "Die Freigabe erfolgte durch {creator} ({creatorEmail}).",
      actionLabel: "Übertragene Daten einsehen",
      messageLine: "Hinweis des Absenders: {note}",
    },
    resetPassword: {
      subject: "Ihr {appName}-Passwort zurücksetzen",
      preheader: "Verwenden Sie den nachfolgenden Link, um Ihr Passwort zurückzusetzen.",
    ...
    invite: {
      ...
      preheader: "Melden Sie sich mit Ihren Zugangsdaten an.",
      title: "Sie sind eingeladen",
      intro: "Ein Administrator hat Sie zu {appName} eingeladen.",
